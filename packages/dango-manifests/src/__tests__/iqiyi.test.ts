...
describe('iqiyi manifest', () => {
  ...
  it('danmaku: derives the shard list and maps the decompressed bullet XML', async () => {
    ...
    expect(result).toEqual([
      { p: '1,1,16777215,2007517714656960@iqiyi', m: '花有重开日，人无再少年' },
      { p: '1,1,16777215,4996603324772993@iqiyi', m: 'zZ:楼子生日快乐&#127882;' },
      {
        p: '1,1,16777215,1361606578@iqiyi',
        m: '让我看看有多少人是从结局回来的',
      },
      { p: '1,1,16777215,323648275618770@iqiyi', m: '前奏响起又回到了去年夏天' },
      {
        p: '1,1,16777215,3287143224975360@iqiyi',
        m: '果果：淇淇生日快乐&#129373;',
      },
      { p: '1,1,16777215,2492707721284864@iqiyi', m: '甲辰年腊月二十七纪念一下' },
      { p: '1,5,16777215,1458873445@iqiyi', m: '今天是4刷哦！' },
      {
        p: '2,1,16777215,2300576040@iqiyi',
