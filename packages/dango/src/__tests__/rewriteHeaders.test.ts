...
// passes them to the FetchLike implementation in init.rewriteHeaders. A
// browser host applies them via a request-rewrite mechanism; a server
// FetchLike would just set them directly.
