...
describe('bahamut manifest', () => {
  ...
  it('danmaku: maps time/10, position mode and hex color to canonical {p, m}', async () => {
    ...
    expect(result).toEqual([
      { p: '0,1,16777215,andy475713@baha', m: '1' },
      { p: '0.2,4,16711718,FeiFei88@baha', m: '2025／8／24' },
      { p: '5.4,5,16639293,emu9025@baha', m: '2025/8/12簽' },
      { p: '0.4,1,16777215,efg130@baha', m: '20250802' },
      { p: '0.8,1,16749718,star112999@baha', m: '20240821 我來啦' },
    ])
    expect(calls).toHaveLength(1)
  })
})
