...
import { type HttpStepCache, type RunOptions, runPipeline } from './runner.js'
...
export class ManifestRunner {
  ...
  private readonly httpCache: HttpStepCache = new Map()

  constructor(
    public readonly manifest: Manifest,
    private readonly options: ManifestRunnerOptions = {}
  ) {
    this.protoRegistry = new ProtoRegistry(manifest.protoDescriptors)
  }
